...
import type { u32, u64 } from '@stellar/stellar-sdk/lib/contract_client';
...
export declare const networks: {
    readonly unknown: {
        ...
        readonly contractId: "CBOC24RLZHETOADX2KHKO5WWV4K6E3DKX6T5SUUPKJXI6JC2SSX47BUI";
    };
};
...
export interface Client {
     ...
     */
    create_offer: ({ offeror, send_token, recv_token, timestamp, send_amount, recv_amount, min_recv_amount }: {
        offeror: string;
        send_token: string;
        recv_token: string;
        timestamp: u32;
     ...
     */
    accept_offer: ({ acceptor, offer_id, amount }: {
        acceptor: string;
        offer_id: u32;
        amount: u64;
    }, options?: {
     ...
     */
    update_offer: ({ offeror, offer_id, recv_amount, min_recv_amount }: {
        offeror: string;
        offer_id: u32;
        recv_amount: u64;
        min_recv_amount: u64;
     ...
     */
    check_balances: ({ account, send_token, recv_token }: {
        account: string;
        send_token: string;
        recv_token: string;
    }, options?: {
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        ...
        get_fee: (json: string) => AssembledTransaction<readonly [number, string]>;
        allow_token: (json: string) => AssembledTransaction<null>;
        disallow_token: (json: string) => AssembledTransaction<null>;
        get_error: (json: string) => AssembledTransaction<number>;
        count_offers: (json: string) => AssembledTransaction<number>;
        create_offer: (json: string) => AssembledTransaction<number>;
        accept_offer: (json: string) => AssembledTransaction<number>;
        update_offer: (json: string) => AssembledTransaction<number>;
        close_offer: (json: string) => AssembledTransaction<number>;
        load_offer: (json: string) => AssembledTransaction<readonly [string, string, string, bigint, bigint, bigint, number]>;
        check_balances: (json: string) => AssembledTransaction<readonly [bigint, bigint]>;
    };
}
